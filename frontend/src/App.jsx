...
import { Home as HomeIcon, User, History as HistoryIcon } from 'lucide-react';
...
function Navigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-zinc-900 border-t border-zinc-800 p-4 flex justify-around items-center z-50">
      <Link to="/" className={`flex flex-col items-center ${location.pathname === '/' ? 'text-emerald-400' : 'text-zinc-500'}`}>
